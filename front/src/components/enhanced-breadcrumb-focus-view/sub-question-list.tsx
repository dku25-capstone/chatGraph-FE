...
import { MessageSquare, ChevronDown, ChevronUp, MoreHorizontal } from "lucide-react";
...
const userBubbleClasses = "p-4 rounded-2xl bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 mb-2";
